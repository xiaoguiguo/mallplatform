 ...
 * @Author: doudou
 * @Datetime: 2019/11/21-16:52
 * @Description: 生成带注释的代码
 */
public class MyCommentGenerator implements CommentGenerator {
    ...
    public MyCommentGenerator() {
        ...
        currentDateStr = LocalDateTime.now().toLocalDate().toString();
    }
...
//        sb.setLength(0);
//        sb.append(" * @author ");
//        sb.append(systemPro.getProperty("doudouj"));
//        sb.append(" ");
